<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ManageCustomers.aspx.cs" Inherits="CRMLight.Customers.ManageCustomers" %>
...
<%--    <asp:Content runat="server" ID="FeaturedContent" ContentPlaceHolderID="FeaturedContent">
    ...
    <h3>New Customer</h3>
    <br />
    <input id="txtName" type="text" placeholder="FirstName" /><br />
    ...
    <script type="text/javascript">
        ...
        function updateCustomer() {
            ...
            $.ajax({
                ...
                contentType: "application/json;charset=utf-8",
                success: function (data) {
                    $('#UpdateCustomerDetail').html('<li>(' + data.CustomerID + ') FirstName=' + data.FirstName + ' Email=' + data.Email + '</li>');
                },
                error: function (x, y, z) {
                    alert(x + '\n' + y + '\n' + z);
                }
